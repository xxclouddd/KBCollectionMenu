...
@interface KBCollectionMenuLayout : UICollectionViewFlowLayout
...
@protocol KBCollectionMenuLayoutDataSource <UICollectionViewDataSource>
...
@protocol KBCollectionMenuLayoutDelegateFlowLayout <UICollectionViewDelegateFlowLayout>
@optional
