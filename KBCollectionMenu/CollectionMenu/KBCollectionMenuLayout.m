...
@interface KBCollectionMenuLayout () <UIGestureRecognizerDelegate>
{
...
@property (assign, nonatomic, readonly) id<KBCollectionMenuLayoutDataSource> dataSource;
@property (assign, nonatomic, readonly) id<KBCollectionMenuLayoutDelegateFlowLayout> delegate;

@end

@implementation KBCollectionMenuLayout
...
- (id<KBCollectionMenuLayoutDataSource>)dataSource {
    return (id<KBCollectionMenuLayoutDataSource>)self.collectionView.dataSource;
}

- (id<KBCollectionMenuLayoutDelegateFlowLayout>)delegate {
    return (id<KBCollectionMenuLayoutDelegateFlowLayout>)self.collectionView.delegate;
}
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer {
    if ([self.panGestureRecognizer isEqual:gestureRecognizer]) {
        ...
        id<KBCollectionMenuLayoutDelegateFlowLayout> delegate = self.delegate;
